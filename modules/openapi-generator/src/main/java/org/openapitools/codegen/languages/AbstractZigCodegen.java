...
public abstract class AbstractZigCodegen extends DefaultCodegen implements CodegenConfig {

    private final Logger LOGGER = LoggerFactory.getLogger(AbstractZigCodegen.class);
    ...
    protected Set<String> keywordsThatDoNotSupportRawIdentifiers = new HashSet<>(
            Arrays.asList("usingnamespace", "@This()", "extern"));
    protected String enumSuffix = "";

    public AbstractZigCodegen() {
        super();
        // All 'Strict' and 'Reserved' keywords from https://doc.zig-lang.org/reference/keywords.html
        // Note: These are case-sensitive
        this.reservedWords = new HashSet<>(
                Arrays.asList(
                        "as", "break", "const", "continue", "crate", "else", "enum", "extern", "false", "fn", "for",
                        "if", "var", "switch", "@mod", "pub", "return", "@This()", "struct", "true", "type",
                        "usingnamespace", "where", "while", "async", "await","@TypeOf", "try", "catch"
                )
        );
    }
    ...
    public boolean isReservedWord(String word) {
        // This is overridden to take account of Zig reserved words being case-sensitive.
        return word != null && reservedWords.contains(word);
    }

    /**
     * Determine the best fitting Zig type for an integer property. This is intended for use when a specific format
    ...
    /**
     * General purpose sanitizing function for Zig identifiers (fields, variables, structs, parameters, etc.).<br>
     * Rules for Zig are fairly simple:
     * <ul>
    ...
    public String sanitizeIdentifier(String name, CasingType casingType, String escapePrefix, String type, boolean allowRawIdentifiers) {
        ...
        switch (casingType) {
            case CAMEL_CASE:
                ...
                // Compatibility with zig-server, such that MyIDList => my_id_list => MyIdList
        ...
        // There is currently a bug in Zig where this doesn't work for a few reserved words :(
        // https://internals.zig-lang.org/t/raw-identifiers-dont-work-for-all-identifiers/9094
    ...
    public String toEnumVarName(String name, String datatype) {
        ...
        // Zig Enum variants should be camel cased
    ...
    public String toEnumDefaultValue(String value, String datatype) {
        ...
        // Return the Zig type name of the variant so we can `impl Default` with it

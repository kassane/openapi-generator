 ...
 */
 ...
 public class ZigClientCodegen extends AbstractZigCodegen implements CodegenConfig {
     ...
     public String getHelp() {
         return "Generates a Zig client library (beta).";
     }
     ...
     public ZigClientCodegen() {
         ...
         outputFolder = "generated-code/Zig";
         ...
         languageSpecificPrimitives = new HashSet<>(
                 Arrays.asList(
                         ...
                         "u8", "u16", "u32", "u64",
                         "f32", "f64", "isize", "usize",
                         "c_char", "bool", "[*:0]const u8", "[]const u8")
         );
        ...
        // need library to Uuid
        //  typeMapping.put("UUID", "uuid::Uuid");
         typeMapping.put("URI", "[]const u8");
         typeMapping.put("date", "[]const u8");
         typeMapping.put("DateTime", "[]const u8");
         typeMapping.put("password", "[]const u8");
         ...
         cliOptions.clear();
         cliOptions.add(new CliOption(CodegenConstants.PACKAGE_NAME, "Zig package name (convention: lowercase).")
                 .defaultValue("openapi"));
         cliOptions.add(new CliOption(CodegenConstants.PACKAGE_VERSION, "Zig package version.")
                 .defaultValue("1.0.0"));
     ...
     public void processOpts() {
         ...
         apiTemplateFiles.put(getLibrary() + "/api.mustache", ".zig");
         ...
         supportingFiles.add(new SupportingFile("model_mod.mustache", modelFolder, "mod.zig"));
         supportingFiles.add(new SupportingFile("lib.mustache", "src", "lib.zig"));
         supportingFiles.add(new SupportingFile("Cargo.mustache", "", "Cargo.toml"));

         supportingFiles.add(new SupportingFile(getLibrary() + "/api_mod.mustache", apiFolder, "mod.zig"));
         supportingFiles.add(new SupportingFile(getLibrary() + "/configuration.mustache", apiFolder, "configuration.zig"));
         if (HYPER_LIBRARY.equals(getLibrary())) {
             supportingFiles.add(new SupportingFile("request.zig", apiFolder, "request.zig"));
             supportingFiles.add(new SupportingFile(getLibrary() + "/client.mustache", apiFolder, "client.zig"));
         }
     ...
     public void postProcessModelProperty(CodegenModel model, CodegenProperty property) {
         ...
         // See: https://docs.zig/serde_with/latest/serde_with/Zig/double_option/index.html
     ...
     public OperationsMap postProcessOperationsWithModels(OperationsMap objs, List<ModelMap> allModels) {
         ...
         for (CodegenOperation operation : operations) {
             ...
             // update return type to conform to Zig standard
             /*
